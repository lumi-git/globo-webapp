...
variable "api_key_secret_id" {
  type        = string
  description = "(Required)secret id for api key"
}

variable "tfe_organization" {
  type        = string
  description = "(Required) organisation name of tfe organization."
}

variable "tfe_workspace_name" {
  type        = string
  description = "(Required)name pf tje workplace"
}

variable "playbook_repository" {
  type        = string
  description = "(Required) URI of the playbook that should be executed on the vm"
}
